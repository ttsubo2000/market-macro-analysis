...
![日銀マクロ経済モニタリング 統合チャート](../../report/png/combined_chart.png)
...
![需給ギャップ（GDPギャップ）](../../report/png/gdp_gap_chart.png)
...
![コアCPI（生鮮食品を除く総合・前年比）](../../report/png/cpi_chart.png)
...
![BEI（ブレーク・イーブン・インフレ率）](../../report/png/expected_inflation_chart.png)
...
![インフレギャップ（コアCPI − 物価安定目標 2%）](../../report/png/inflation_gap_chart.png)
...
![政策金利・実質金利（金融ブロック）](../../report/png/policy_rate_chart.png)
...
> チャート画像は `uv run python main.py make_chart all` で `report/png/` に生成されます。

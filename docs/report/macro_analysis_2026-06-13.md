...
2025年11月の3.0%をピークに急落が続いており、2026年4月は1.4%まで低下した。特に注目すべきは **2026年1月に2.0%の目標水準に到達しながら、翌月以降に反落した**点だ。この「目標到達→即反落」のパターンは、物価上昇の基調的な定着がまだ脆弱であることを示唆する。
...
#### 需給ギャップ：改善トレンドで物価の下支えに期待

2026年Q1に+0.5%へ改善しており、需要面からの物価押し上げ圧力は存在している。ただしGDPギャップは「経済全体の需給」を示す指標であり、消費者物価への波及には通常3〜6ヶ月のラグがある。現在のCPIの落ち込みに需給ギャップの改善が追いついてくるのは2026年後半と見られる。

#### BEI（期待インフレ率）：市場は目標超えを継続予測

BEIは2.17%と、日銀の物価安定目標（2%）を上回っている。コアCPIが1.4%に落ち込んでいるにもかかわらず、市場参加者は「将来的に2%を超えるインフレが定着する」と見ていることを示す。この **「現実のCPI（1.4%）とBEI（2.17%）の乖離 0.77%ポイント」** が現在最も注目すべきギャップだ。

市場の楽観が正しければ→コアCPIは今後反発し、利上げ継続が正当化される。
市場の楽観が過剰であれば→BEIが低下方向に修正され、日銀の政策見直しが迫られる。

#### 実質金利：自然利子率との乖離2%ポイント近く
...
実質金利が自然利子率を約2%ポイント下回っており、金融環境は**大幅に緩和的**。これは名目金利が0.727%でも、物価期待を差し引くと企業・家計が「実質的にはほぼタダで資金調達できる」状態を意味する。日銀が「利上げをしても緩和姿勢は維持」と説明する根拠がここにある。
...
ただし、6月に入って68,402円の高値をつけた後、やや調整局面（66,000円台）に入っており、短期的な過熱感も台頭している。

**株高が金融政策に与える含意**：株価上昇は「企業活動の活性化→雇用改善→賃金上昇→物価上昇」という好循環の入り口であるため、日銀の「賃金・物価の好循環」の物語を支持する材料となる。しかしコアCPIが実際には低下中であることを踏まえると、「株高が先走りしており、実体経済が追いついていない」リスクも存在する。
...
コアCPIの下落が続き、内需の弱さが確認された場合、「2026年内の追加利上げはない」との市場コンセンサスが形成されるシナリオ。円高への転換リスクも伴う。
...
この場合、日銀は利上げペースを加速し、年内に政策金利が1.0%に近づく可能性がある。
...
この場合、日銀は利上げを停止し、最悪のケースでは緩和方向への転換が議論される。
